...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_backward15', [dirname(__file__)])
        except ImportError:
            import _backward15
            return _backward15
        if fp is not None:
            try:
                _mod = imp.load_module('_backward15', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _backward15 = swig_import_helper()
...
class Input(daal.algorithms.neural_networks.layers.backward.Input):
    ...
    def __init__(self, *args):
        this = _backward15.new_Input(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _backward15.delete_Input
    __del__ = lambda self: None

    def check(self, par, method):
        return _backward15.Input_check(self, par, method)
Input_swigregister = _backward15.Input_swigregister
...
class Result(daal.algorithms.neural_networks.layers.backward.Result):
    ...
    def __init__(self):
        this = _backward15.new_Result()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _backward15.delete_Result
    __del__ = lambda self: None

    def check(self, input, par, method):
        return _backward15.Result_check(self, input, par, method)
Result_swigregister = _backward15.Result_swigregister
Result_swigregister(Result)

class Batch(daal.algorithms.neural_networks.layers.backward.LayerIfaceImpl):
    __swig_setmethods__ = {}
    ...
    def clone(self):
        return _backward15.Batch_clone(self)
    __swig_destroy__ = _backward15.delete_Batch
    __del__ = lambda self: None
Batch_swigregister = _backward15.Batch_swigregister
