...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_abs1', [dirname(__file__)])
        except ImportError:
            import _abs1
            return _abs1
        if fp is not None:
            try:
                _mod = imp.load_module('_abs1', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _abs1 = swig_import_helper()
...
daal.algorithms.neural_networks.layers = sys.modules['daal.algorithms.neural_networks.layers']
del sys


_abs1.defaultDense_swigconstant(_abs1)
defaultDense = _abs1.defaultDense

_abs1.auxData_swigconstant(_abs1)
auxData = _abs1.auxData

_abs1.lastLayerDataId_swigconstant(_abs1)
lastLayerDataId = _abs1.lastLayerDataId
class Parameter(daal.algorithms.neural_networks.layers.Parameter):
    ...
    def __init__(self):
        this = _abs1.new_Parameter()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _abs1.delete_Parameter
    __del__ = lambda self: None
Parameter_swigregister = _abs1.Parameter_swigregister
...
class Batch_Float64DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _abs1.Batch_Float64DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _abs1.Batch_Float64DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_abs1.Batch_Float64DefaultDense_parameter_get, _abs1.Batch_Float64DefaultDense_parameter_set)

    def __init__(self):
        this = _abs1.new_Batch_Float64DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _abs1.delete_Batch_Float64DefaultDense
    __del__ = lambda self: None
Batch_Float64DefaultDense_swigregister = _abs1.Batch_Float64DefaultDense_swigregister
...
class Batch_Float32DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _abs1.Batch_Float32DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _abs1.Batch_Float32DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_abs1.Batch_Float32DefaultDense_parameter_get, _abs1.Batch_Float32DefaultDense_parameter_set)

    def __init__(self):
        this = _abs1.new_Batch_Float32DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _abs1.delete_Batch_Float32DefaultDense
    __del__ = lambda self: None
Batch_Float32DefaultDense_swigregister = _abs1.Batch_Float32DefaultDense_swigregister
