...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_forward24', [dirname(__file__)])
        except ImportError:
            import _forward24
            return _forward24
        if fp is not None:
            try:
                _mod = imp.load_module('_forward24', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _forward24 = swig_import_helper()
...
class Input(daal.algorithms.neural_networks.layers.forward.Input):
    ...
    def __init__(self, *args):
        this = _forward24.new_Input(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _forward24.delete_Input
    __del__ = lambda self: None

    def getWeightsSizes(self, parameter):
        return _forward24.Input_getWeightsSizes(self, parameter)

    def getBiasesSizes(self, parameter):
        return _forward24.Input_getBiasesSizes(self, parameter)

    def check(self, parameter, method):
        return _forward24.Input_check(self, parameter, method)
Input_swigregister = _forward24.Input_swigregister
...
class Result(daal.algorithms.neural_networks.layers.forward.Result):
    ...
    def __init__(self):
        this = _forward24.new_Result()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _forward24.delete_Result
    __del__ = lambda self: None

    def getValueSize(self, inputSize, par, method):
        return _forward24.Result_getValueSize(self, inputSize, par, method)

    def check(self, input, parameter, method):
        return _forward24.Result_check(self, input, parameter, method)

    def allocate_Float64(self, input, parameter, method):
        r"""
    This function is specialized for float64"""
        return _forward24.Result_allocate_Float64(self, input, parameter, method)


    def allocate_Float32(self, input, parameter, method):
        r"""
    This function is specialized for float32"""
        return _forward24.Result_allocate_Float32(self, input, parameter, method)

Result_swigregister = _forward24.Result_swigregister
