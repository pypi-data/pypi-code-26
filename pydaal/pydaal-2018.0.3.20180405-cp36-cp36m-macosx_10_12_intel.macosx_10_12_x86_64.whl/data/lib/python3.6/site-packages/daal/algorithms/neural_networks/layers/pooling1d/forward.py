...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_forward22', [dirname(__file__)])
        except ImportError:
            import _forward22
            return _forward22
        if fp is not None:
            try:
                _mod = imp.load_module('_forward22', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _forward22 = swig_import_helper()
...
class Input(daal.algorithms.neural_networks.layers.forward.Input):
    ...
    def __init__(self, *args):
        this = _forward22.new_Input(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _forward22.delete_Input
    __del__ = lambda self: None

    def getWeightsSizes(self, parameter):
        return _forward22.Input_getWeightsSizes(self, parameter)

    def getBiasesSizes(self, parameter):
        return _forward22.Input_getBiasesSizes(self, parameter)

    def check(self, parameter, method):
        return _forward22.Input_check(self, parameter, method)
Input_swigregister = _forward22.Input_swigregister
...
class Result(daal.algorithms.neural_networks.layers.forward.Result):
    ...
    def __init__(self):
        this = _forward22.new_Result()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _forward22.delete_Result
    __del__ = lambda self: None

    def getValueSize(self, inputSize, par, method):
        return _forward22.Result_getValueSize(self, inputSize, par, method)

    def check(self, input, parameter, method):
        return _forward22.Result_check(self, input, parameter, method)

    def allocate_Float64(self, input, parameter, method):
        r"""
    This function is specialized for float64"""
        return _forward22.Result_allocate_Float64(self, input, parameter, method)


    def allocate_Float32(self, input, parameter, method):
        r"""
    This function is specialized for float32"""
        return _forward22.Result_allocate_Float32(self, input, parameter, method)

Result_swigregister = _forward22.Result_swigregister
