...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_backward24', [dirname(__file__)])
        except ImportError:
            import _backward24
            return _backward24
        if fp is not None:
            try:
                _mod = imp.load_module('_backward24', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _backward24 = swig_import_helper()
...
class Input(daal.algorithms.neural_networks.layers.backward.Input):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _backward24.delete_Input
    __del__ = lambda self: None

    def getGradientSize(self):
        return _backward24.Input_getGradientSize(self)
Input_swigregister = _backward24.Input_swigregister
...
class Result(daal.algorithms.neural_networks.layers.backward.Result):
    ...
    def __init__(self):
        this = _backward24.new_Result()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _backward24.delete_Result
    __del__ = lambda self: None

    def check(self, input, parameter, method):
        return _backward24.Result_check(self, input, parameter, method)

    def allocate_Float64(self, input, parameter, method):
        r"""
    This function is specialized for float64"""
        return _backward24.Result_allocate_Float64(self, input, parameter, method)


    def allocate_Float32(self, input, parameter, method):
        r"""
    This function is specialized for float32"""
        return _backward24.Result_allocate_Float32(self, input, parameter, method)

Result_swigregister = _backward24.Result_swigregister
